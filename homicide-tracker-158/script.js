...
map.on('load', function () {
  ...
  map.addSource('merge_nb-3phqy7', {
    type: 'vector',
    url: 'mapbox://luciferyellow.60x6bicm'
  });
  ...
  document.getElementById('slider').addEventListener('input', function(e) {
    ...
    document.getElementById('occurrence-year').innerText = year;
  });
  ...
  map.on('mousemove', function(e) {
    ...
    if (nbhs.length > 0) {
      document.getElementById('pd').innerHTML = '<h3><strong>' + nbhs[0].properties.AREA_NAME + 
        '</strong></h3><p><strong><em>' + nbhs[0].properties.BLK + '</strong>% Black population. Median: 6.8%</em></p>' + 
        '</strong></h3><p><strong><em>' + nbhs[0].properties.UNEMP + '</strong>% Unemployment rate. Median: 13.7%</em></p>' + 
        '</strong></h3><p><strong><em>' + nbhs[0].properties.LOW_INCOME + '</strong>% Low income prevalence (LIM-AT). Median: 12.2%</em></p>' + 
        '</strong></h3><p><strong><em>' + nbhs[0].properties.NO_CERT + '</strong>% No certificate, diploma or degree. Median: 14.0%</em></p>' + 
        '</strong></h3><p><small><em>Source: <a href="https://open.toronto.ca/dataset/neighbourhood-profiles/">2021 Census Neighbourhood Profiles</small></em></a></p>'; 
    } else {
      document.getElementById('pd').innerHTML = '<p>Hover over a neighbourhood!</p><br><br><br><br><br><br><br>' + 
        '<p><small><em>Source: <a href="https://open.toronto.ca/dataset/neighbourhood-profiles/">2021 Census Neighbourhood Profiles</small></em></a></p>';
    }       
  });
